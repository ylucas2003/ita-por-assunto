...
Uso:
    ...
    python pipeline/processar_2fase.py --dir ../../ita2fase
...
# Por padrão procuramos os PDFs da 2ª fase em ../../ita2fase (relativo ao pacote).
DIR_2FASE_DEFAULT = (PROJETO_ROOT / ".." / ".." / "ita2fase").resolve()
